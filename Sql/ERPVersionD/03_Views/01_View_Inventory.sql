...
if exists(select 1 from sysobjects where name='Inventory')
begin
...
as
select T0.CodigoBarras,T0.Descripcion,T0.InventarioBase,isnull(T1.Compra,0) Compra,isnull(T3.Entrada,0) Entrada,isnull(T2.Venta,0) Venta
